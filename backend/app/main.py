...
from saknussemm import __version__ as _saknussemm_version
...
def create_app() -> FastAPI:
    ...
    # startup, our endpoints, saknussemm's emitted events via LoggingObserver)
    ...
    app = FastAPI(
        ...
        # Single version source: the backend tracks the saknussemm library
        # it embeds (audit: backend version was a hardcoded "1.0.0"
        # drifting from the package version).
        version=_saknussemm_version,
        lifespan=lifespan,
    )
